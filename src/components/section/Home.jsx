        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    A passionate developer crafting web experiences with React, Tailwind CSS, and more. My goal is to build soltions that offer both exceptional performance and a delight user experience.
                </p>
