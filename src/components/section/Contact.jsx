...
export const Contact = () => {
    ...
    return <section id="contact" className="min-h-screen flex items-center justify-center py-20">
        <RevealOnScroll>
            <div className="max-w-sm md:max-w-lg flex flex-col px-4 w-150">
                ...
                <form className="space-y-6" onSubmit={hanldeSubmit}>
                    ...
                    <button type="submit" className="w-full bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overfloe-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4">Send Message</button>
